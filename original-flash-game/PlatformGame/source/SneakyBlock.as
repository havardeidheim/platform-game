package source {
	...
	public class SneakyBlock extends AbstractObject{
		
		public function SneakyBlock(xx:int, yy:int, aWidth:int, aHeight:int) {
			super(xx,yy);
			this.x = xx;
			this.y = yy;
			this.width = aWidth;
		...
		public override function setAlpha(a:Number) {
			if (a > 1 || a < 0) {
				throw "illegal argument";
			}else {
				a == 1 ? alpha = 0.2 : alpha = 1;
			}
		}
	}//END
}//END